...
{
    [TestFixture]
    public class CerrarUnaIncidenciaYVerQueSeHaCerrado
    {
        ...
        [Test]
        public void TheCerrarUnaIncidenciaYVerQueSeHaCerradoTest()
        {
            ...
            driver.FindElement(By.Id("cerrar-0")).Click();
            try
            {
                Assert.AreEqual("Incidencia 3", driver.FindElement(By.Id("Asunto-0")).Text);
            }
