    ...
    public class ContextoTransistente : ContextoIncidencias
    {
        public ContextoTransistente() : base(DbConnectionFactory.CreateTransient())
        {
            ...
            Incidencias.AddRange(new[]
            {
                ...
                new Incidencia() { IdIncidencia = 3, Timestamp = DateTime.UtcNow, Asunto = "Incidencia 3", Comentario = "Comentario 3", Centro = centros[1], Aula = "Aula3", Equipo = "E32", Cerrada = false },
                new Incidencia() { IdIncidencia = 4, Timestamp = DateTime.UtcNow, Asunto = "Incidencia 4", Comentario = "Comentario 4", Centro = centros[2], Aula = "Aula4", Equipo = "E49", Cerrada = false },
                new Incidencia() { IdIncidencia = 5, Timestamp = DateTime.UtcNow, Asunto = "Incidencia 5", Comentario = "Comentario 5", Centro = centros[2], Aula = "Aula5", Equipo = "E50", Cerrada = false }
            });
